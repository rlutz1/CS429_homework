...
log = LogisticRegressionGD(eta=0.01, n_iter=100) # note that eta needs to be small here!
log.fit(X, y) # hand off the iris data and correct labels to learning algorithm
